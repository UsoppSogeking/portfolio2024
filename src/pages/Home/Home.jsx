                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                            <div className="project-card bg-light-panel dark:bg-dark-panel p-6 rounded-lg shadow-md transition-transform transform hover:scale-105 flex flex-col">
                                <div className="flex flex-col justify-between h-full">
                                    <div>
                                        <img src={feed360} alt="Projeto 1" className="w-full h-48 object-cover mb-4 rounded-lg" />
                            ...
                            <div className="project-card bg-light-panel dark:bg-dark-panel p-6 rounded-lg shadow-md transition-transform transform hover:scale-105 flex flex-col">
                                <div className="flex flex-col justify-between h-full">
                                    <div>
                                        <img src={blogtechImage} alt="Projeto 2" className="w-full h-48 object-cover mb-4 rounded-lg" />
